...
{
    public const string UserCacheTag = "user_cache";
    public const string UserCacheKey = "user_cache_{0}";

    public const string RoleCacheTag = "role_cache";
    public const string RoleCacheKey = "role_cache_{0}";
