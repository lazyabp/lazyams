...
public class DBSeedDataService : IDBSeedDataService, ITransientDependency
{
    ...
    private List<Menu> menus = new List<Menu>()
    {
        ...
        new Menu(){Id=33, ParentId=30, Icon="", Name="SetAsPaid", Title="设为已付款",MenuType= MenuType.Btn, OrderNum=2, Permission=PermissionConsts.Order.SetAsPaid, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=34, ParentId=30, Icon="", Name="SetAsComplited", Title="设为已完成",MenuType= MenuType.Btn, OrderNum=2, Permission=PermissionConsts.Order.SetAsComplited, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=35, ParentId=30, Icon="", Name="SetAsCanceled", Title="取消订单",MenuType= MenuType.Btn, OrderNum=2, Permission=PermissionConsts.Order.SetAsCanceled, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=36, ParentId=30, Icon="", Name="SetAsRefund", Title="订单退款",MenuType= MenuType.Btn, OrderNum=2, Permission=PermissionConsts.Order.SetAsRefund, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=37, ParentId=30, Icon="", Name="Delete", Title="删除订单",MenuType= MenuType.Btn, OrderNum=3, Permission=PermissionConsts.Order.Delete, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},

        new Menu(){Id=40, ParentId=29, Icon="el-icon-box", Name="Package", Title="套餐管理", MenuType=MenuType.Menu, OrderNum=2, Route="/package", Component="package/index", Permission=PermissionConsts.Package.Default, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=41, ParentId=40, Icon="", Name="Add", Title="添加套餐",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.Package.Add, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=42, ParentId=40, Icon="", Name="Update", Title="更新套餐",MenuType= MenuType.Btn, OrderNum=2, Permission=PermissionConsts.Package.Update, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=43, ParentId=3404, Icon="", Name="Delete", Title="删除套餐",MenuType= MenuType.Btn, OrderNum=3, Permission=PermissionConsts.Package.Delete, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},

        new Menu(){Id=50, ParentId=40, Icon="el-icon-menu", Name="PackageFeature", Title="套餐功能管理", MenuType=MenuType.Dir, OrderNum=3, Route="/package-feature", Component="package/feature", Permission=PermissionConsts.PackageFeature.Default, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = false},
        new Menu(){Id=51, ParentId=50, Icon="", Name="Add", Title="添加功能",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.PackageFeature.Add, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=52, ParentId=50, Icon="", Name="Update", Title="更新功能",MenuType= MenuType.Btn, OrderNum=2, Permission=PermissionConsts.PackageFeature.Update, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=53, ParentId=50, Icon="", Name="Delete", Title="删除功能",MenuType= MenuType.Btn, OrderNum=3, Permission=PermissionConsts.PackageFeature.Delete, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},

        new Menu(){Id=60, ParentId=29, Icon="el-icon-user", Name="UserSubscription", Title="用户订阅管理", MenuType=MenuType.Menu, OrderNum=4, Route="/user-subscription", Component="user-subscription/index", Permission=PermissionConsts.UserSubscription.Default, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=61, ParentId=60, Icon="", Name="Update", Title="更新订阅",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.UserSubscription.Update, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=62, ParentId=60, Icon="", Name="SetAsExpired", Title="设为已过期",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.UserSubscription.SetAsExpired, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=63, ParentId=60, Icon="", Name="SetAsFreezed", Title="冻结订阅",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.UserSubscription.SetAsFreezed, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=64, ParentId=60, Icon="", Name="SetAsActive", Title="激活订阅",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.UserSubscription.SetAsActive, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
        new Menu(){Id=65, ParentId=60, Icon="", Name="Update", Title="更新订阅",MenuType= MenuType.Btn, OrderNum=1, Permission=PermissionConsts.UserSubscription.Update, CreatedBy=1,CreatedAt= DateTime.Now, IsActive = true},
    };
